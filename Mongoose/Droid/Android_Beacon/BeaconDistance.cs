...
{
	public class BeaconDistance : View
	{
		Drawable _drawable;

		public BeaconDistance(Context context) :
		base(context)
		{
			Initialize(context);
		}

		public BeaconDistance(Context context, IAttributeSet attrs) :
		base(context, attrs)
		{
			Initialize(context);
		}

		public BeaconDistance(Context context, IAttributeSet attrs, int defStyle) :
