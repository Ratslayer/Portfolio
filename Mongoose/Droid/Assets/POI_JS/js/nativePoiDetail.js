...
var World = {
	...
	poiDrawable_idle: null,
	poiDrawable_selected: null,
	buildingDrawable_idle: null,
	buildingDrawable_selected: null,
	...
	loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData, lang) 
{
		...
		World.poiDrawable_idle = new AR.ImageResource("assets/poi_icon_idle.png");
		World.poiDrawable_selected = new AR.ImageResource("assets/poi_icon_selected.png");
		World.buildingDrawable_idle = new AR.ImageResource("assets/building_icon_idle.png");
		World.buildingDrawable_selected = new AR.ImageResource("assets/building_icon_selected.png");
		...
		var localizedString = chooseLang(lang);
		World.updateStatusMessage(localizedString.Message);
