...
function Marker(poiData) {
    ...
    */
    ...
    var drawable_idle, drawable_selected;
    if(this.poiData.id === 0)
    {
    	drawable_idle = World.poiDrawable_idle;
    	drawable_selected = World.poiDrawable_selected;
    }
   	else
   	{
   		drawable_idle = World.buildingDrawable_idle;
    	drawable_selected = World.buildingDrawable_selected;
   	}
    // create an AR.ImageDrawable for the marker in idle state
    this.markerDrawable_idle = new AR.ImageDrawable(drawable_idle, 2.5, {
        zOrder: 0,
        opacity: 1.0,
        /*
    ...
    this.markerDrawable_selected = new AR.ImageDrawable(drawable_selected, 2.5, {
        zOrder: 0,
        opacity: 0.0,
        onClick: null
    });
    ...
    this.titleLabel = new AR.Label(poiData.title.trunc(0), 1, {
        zOrder: 1,
        offsetY: 0.55,
        style: {
            textColor: '#FFFFFF',
    ...
    this.descriptionLabel = new AR.Label(poiData.description.trunc(0), 0.8, {
        zOrder: 1,
        offsetY: -0.55,
        style: {
            textColor: '#FFFFFF'
